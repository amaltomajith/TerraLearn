...
Full design context for every feature that's been planned but has no code yet. Each section is meant to stand alone — enough background, data sources, and guardrails that someone could pick up any one section and start building without needing the conversations that produced it.
